...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Buy and sell across Algeria: cars, real estate, phones, electronics, jobs and more on ALGZONE." },
      { property: "og:title", content: "ALGZONE — Algeria's #1 Classifieds Marketplace" },
      { property: "og:description", content: "Buy and sell across Algeria: cars, real estate, phones, electronics, jobs and more on ALGZONE." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "ALGZONE — Algeria's #1 Classifieds Marketplace" },
      { name: "twitter:description", content: "Buy and sell across Algeria: cars, real estate, phones, electronics, jobs and more on ALGZONE." },
